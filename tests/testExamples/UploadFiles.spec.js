...
test('Single File',async ({page})=>{
    ...
    await page.locator('#file-upload').setInputFiles('tests/testExamples//uploadFiles/testfile1.pdf')
...
test('Multiple Files',async ({page})=>{
    ...
    await page.locator('#filesToUpload')
                .setInputFiles(['tests/testExamples/uploadFiles/testfile1.pdf',
                                 'tests/testExamples/uploadFiles/testfile2.pdf']);
